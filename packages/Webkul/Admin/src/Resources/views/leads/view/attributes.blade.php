        ...
        <form @submit="handleSubmit($event, () => {})">
            ...
            <x-admin::attributes.view
                :custom-attributes="app('Webkul\Attribute\Repositories\AttributeRepository')->findWhere([
                    'entity_type' => 'leads',
                    ['code', 'NOTIN', ['title', 'description', 'lead_pipeline_id', 'lead_pipeline_stage_id','lead_value','lead_source_id','lead_type_id','user_id','expected_close_date','identification_number']]
                ])"
                :entity="$lead"
